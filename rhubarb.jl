...
@time sol2 = gql(lx,ly,nx,ny,Λ,Ξ,β,τ,dt=0.005,ts_alg=ETDRK4,ic=ζ0,t_end=200.0,savefreq=5);

@time sol3a = gce2(lx,ly,nx,ny,Λ,Ξ,β,τ,ic=ζ0,ts_alg=RK4,dt=0.001,t_end=200.0,poscheck=false,savefreq=5);
@time sol3 = gce2(lx,ly,nx,ny,Λ,Ξ,β,τ,ic=ζ0,ts_alg=ETDRK4,dt=0.001,t_end=200.0,poscheck=false,savefreq=5);
